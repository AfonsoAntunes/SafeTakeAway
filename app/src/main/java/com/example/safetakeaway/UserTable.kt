...
class UserTable (db: SQLiteDatabase) : BaseColumns {
    ...
    fun createTable() =
        db.execSQL(
            "CREATE TABLE $USER_TABLE (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $NAME TEXT NOT NULL, $GENDER TEXT NOT NULL, $ADDRESS TEXT NOT NULL, $EMAIL TEXT NOT NULL, $PHONE_NUMBER TEXT NOT NULL)"
        )
    ...
    companion object {
        ...
        val ALL_FIELD = arrayOf(BaseColumns._ID, NAME, GENDER, ADDRESS, EMAIL, PHONE_NUMBER)
    }
}
