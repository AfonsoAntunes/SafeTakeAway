...
class OrderTable (db: SQLiteDatabase) : BaseColumns {
    ...
    companion object {
        ...
        val ALL_FIELD = arrayOf(BaseColumns._ID, TOTAL_PRICE, DATE, PAYMENT_METHOD, RESTAURANT_ID, PLATES_ID)
    }
}